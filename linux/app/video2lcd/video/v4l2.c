...
static int V4l2InitDevice(char *strDevName, PT_VideoDevice ptVideoDevice)
{
    ...
    tV4l2Fmt.fmt.pix.width       = 720;//iLcdWidth;
	...
	DBG_PRINTF("tV4l2Fmt.fmt.pix.field = %d\n",tV4l2Fmt.fmt.pix.field);
	...
	//setfps->parm.capture.timeperframe.denominator=15;//15
	//iError = ioctl(iFd, VIDIOC_S_PARM, setfps); 
	//if(iError == 0)
	//	DBG_PRINTF("VIDIOC_S_PARM success\n");
	//
	///* get framerate */
	//iError = ioctl(iFd, VIDIOC_G_PARM, setfps);
	//memset(setfps, 0, sizeof(struct v4l2_streamparm));
	//setfps->type = V4L2_BUF_TYPE_VIDEO_CAPTURE;
	//setfps->parm.capture.capability = V4L2_CAP_TIMEPERFRAME;
	//DBG_PRINTF("setfps->parm.capture.timeperframe.denominator = %d\n",setfps->parm.capture.timeperframe.denominator);
	//if(iError == 0)
	//	DBG_PRINTF("VIDIOC_G_PARM success\n");
