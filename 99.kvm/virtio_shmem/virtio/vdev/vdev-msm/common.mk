...
USEFILE=$(PROJECT_ROOT)/vdev-msm.use

#===== PINFO - the file containing the packaging information for the application.
define PINFO
PINFO DESCRIPTION=vdev-msm traps and emulate APPS Non-Secure watchdog
endef
...
LIBS+= slog2 npa_clientS pdbgS bmetricsS vdev_utilsS
