 ...
 *
 */
#ifndef __QVM_PCI_H_INCLUDED
#define __QVM_PCI_H_INCLUDED
...
#define PCI_MSIX_TABLE_ENTRY_SIZE   0x0010u	/* Number of bytes in each MSIX table entry */
#define	PCI_MSIX_PBA_BIR_MASK       0x0007u	/* MSI-X Base Index Register mask */
...
/** Get the offset of a named configuration register */
#define PCICFG(reg)		((unsigned)(offsetof(struct _pci_config_regs, reg)))	// <STAN_MACRO5/>

#endif

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/utils/q/qvm/public/qvm/hw_pci.h $ $Rev: 844105 $")
#endif
