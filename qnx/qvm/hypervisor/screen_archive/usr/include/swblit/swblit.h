...
typedef enum {
    ...
    SWBLIT_FMT_NV12     = 8,
    SWBLIT_FMT_NV16     = 8 | (1 << SWBLIT_FMT_SHIFT_CSPACE),
} swblit_format_t;
 ...
 *
 */
void * swblit_surface_desc_get_user_data(swblit_surface_desc_t surf);

/*!
 *
 */
void swblit_surface_desc_set_user_data(swblit_surface_desc_t surf, void * user_data);

/*!
 *
 */
void swblit_surface_desc_set_planar_offsets(swblit_surface_desc_t surf,
        int* planar_offsets,
        int num_offsets);
...
#define SWBLIT_SURFACE_INVALIDATE_SRC_RECT 0x1
#define SWBLIT_SURFACE_INVALIDATE_DST_RECT 0x2

/*!
 *
 */
typedef void (*swblit_surface_invalidate_rect_fn_t)(
        swblit_context_t ctx,
        swblit_surface_desc_t surf,
        int x,
        int y,
        int width,
        int height,
 ...
 */
void
swblit_context_set_surface_invalidate_fn(swblit_context_t ctx, swblit_surface_invalidate_rect_fn_t surf_invalidate_rect_fn);

/*!
 *
 */
void
swblit_context_set_user_data(swblit_context_t ctx, void * user_data);

/*!
 *
 */
void *
swblit_context_get_user_data(swblit_context_t ctx);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/dev-renesas-hypervisor/lib/swblit/public/swblit/swblit.h $ $Rev: 864723 $")
#endif
