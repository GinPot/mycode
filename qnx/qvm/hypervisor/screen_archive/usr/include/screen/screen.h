...
/** @brief The feature preprocessor definition that indicates the declaration of
 *         screen_create_window_from_class(). This funciton allows the ability to create a window
...
*          are multiple types of windows (e.g, application, child, embedded) to accomodate the
...
enum {
	...
	*   pixel will be compared to the sensitivty threshold; if the alpha is less
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/dev-renesas-hypervisor/lib/screen/public/screen/screen.h $ $REV$")
#endif
