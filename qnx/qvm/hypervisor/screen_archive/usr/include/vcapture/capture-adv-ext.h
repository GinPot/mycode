...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/dev-renesas-hypervisor/hardware/capture/public/public/vcapture/capture-adv-ext.h $ $Rev: 801492 $")
#endif
