...
/**
* @brief  Device path of the USB resource manager. This
*         property is only applicable to cameras that are connected via USB.
*
*         Read/Write <tt>const char *</tt>
*/
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/dev-renesas-hypervisor/lib/capture/public/vcapture/capture.h $ $Rev: 859162 $")
#endif
