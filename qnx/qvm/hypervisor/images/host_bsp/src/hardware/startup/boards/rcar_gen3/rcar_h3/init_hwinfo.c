...
void init_hwinfo()
{
...

    {
        ...
        for(i = 0; i < NUM_ELTS(dev); i++) {
            ...
            switch(RCAR_GEN3_PRODUCT_REV(in32(RCAR_GEN3_PRODUCT_REGISTER))) {
                case PRODUCT_H3_REV_1_0:
                case PRODUCT_H3_REV_1_1:
                    tag->hwversion.version = 1;
                    break;
                default:
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/boards/rcar_gen3/rcar_h3/init_hwinfo.c $ $Rev: 843831 $")
#endif
