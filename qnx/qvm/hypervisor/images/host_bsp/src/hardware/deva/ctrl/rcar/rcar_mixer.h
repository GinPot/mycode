...
void rcar_mixer_set_default_group( ado_pcm_t *pcm, ado_mixer_t *mixer, int channel, int index );
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/mainline/hardware/deva/ctrl/rcar/rcar_mixer.h $ $Rev: 840692 $")
#endif
