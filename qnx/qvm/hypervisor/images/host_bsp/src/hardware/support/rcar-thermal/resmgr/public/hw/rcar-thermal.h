...
#define DCMD_THSCIVM_GET_TEMP_VOLT      __DIOF(_DCMD_MISC,  DCMD_CMD_CODE + 3, ths_civm_packet_t)

#endif /* _HW_RCAR_THERMAL_H_INCLUDED */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/mainline/hardware/support/rcar-thermal/resmgr/public/hw/rcar-thermal.h $ $Rev: 841525 $")
#endif
