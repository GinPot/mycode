 ...
 */
const struct armv_chip armv_chip_hyp_qc1 = {
        .cpuid          = 0x2010,
        .name           = "Armv8 QC850-1 Guest",
        .cycles         = 2,
        .power          = &power_v7_wfi,
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/arm/armv_chip_hyp_qc1.c $ $Rev: 829879 $")
#endif
