...
extern const struct armv_chip	armv_chip_v8_fm;
extern const struct armv_chip	armv_chip_hyp_a57;
extern const struct armv_chip	armv_chip_hyp_qc1;
extern const struct armv_chip	armv_chip_hyp_qc2;
...
extern void		armv_setup_a7(struct cpuinfo_entry *, unsigned, unsigned);
 ...
 * ------------------------------------------------------------------
 */
extern void init_mx7(unsigned channel, const char *init, const char *defaults);
extern void put_mx7(int);
extern struct callout_rtn	display_char_mx7;
extern struct callout_rtn	poll_key_mx7;
extern struct callout_rtn	break_detect_mx7;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/arm/cpu_startup.h $ $Rev: 851280 $")
#endif
